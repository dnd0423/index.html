...
const quiz = [
{"quesion" : "苦しく辛い出来事も、過ぎ去ってしまえばその苦しさを忘れてしまう。", "kotae": "喉元過ぎれば熱さを忘れる"},
{"quesion" : "風流を楽しむより実益を取る方が良いというたとえ。見かけよりも実質を取ること。", "kotae": "花より団子"},
{"quesion" : "食事を食べ過ぎずに控えめにしておけば、健康を保てるということ。", "kotae": "腹八分目に医者いらず"},
{"quesion" : "少しも手ごたえがないこと。", "kotae": "暖簾に腕押し"},
{"quesion" : "早起きをすると、健康に良かったり、仕事がはかどったりと、なにかとよいことがある。", "kotae": "早起きは三文の徳"}
];
