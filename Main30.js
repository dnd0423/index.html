...
const quiz = [
{"quesion" : "手ごたえがなく効果もないこと。", "kotae": "糠に釘"},
{"quesion" : "ほとんど苦労もせずに大もうけすることのたとえ。", "kotae": "濡れ手で粟"},
{"quesion" : "油断できない状況。危険な状態。", "kotae": "猫に鰹節"},
{"quesion" : "価値のわからない者に貴重な品を与えても、何の役にも立たないことのたとえ。", "kotae": "猫に小判"},
{"quesion" : "実力や才能のある者ほど、それをむやみに見せびらかそうとはしない。", "kotae": "能ある鷹は爪を隠す"}
];
