...
const quiz = [
{"quesion" : "悪い状況でも、あせらずに待っていれば、そのうち良いことがあるということ。", "kotae": "待てば海路の日和あり"},
{"quesion" : "相手を説得しようとしたのにいつの間にか相手に同調してしまう。", "kotae": "ミイラ取りがミイラになる"},
{"quesion" : "自分に都合の悪いことや他人の欠点は、見ないふり、聞かないふりをして、余計なことは言わないようにすること。", "kotae": "見ざる聞かざる言わざる"},
{"quesion" : "言い方ややり方次第で、物事がうまくいくこともあれば、喧嘩になってしまうこともあるということ。。", "kotae": "丸い卵も切りようで四角"},
{"quesion" : "自分がしたことが原因で災難にあうこと。", "kotae": "身から出たさび"}
];
