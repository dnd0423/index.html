...
const quiz = [
{"quesion" : "苦労して完成させた物事に、一番大事なところが抜けていて、役に立たないこと。", "kotae": "仏作って魂入れず"},
{"quesion" : "どんなに温厚な人でも、何回もひどいことをされると、最後には怒りだすということ。", "kotae": "仏の顔も三度"},
{"quesion" : "苦労したのに成果が出ず、徒労に終わってしまうこと。", "kotae": "骨折り損のくたびれもうけ"},
{"quesion" : "結果があるからには必ず原因がある。努力なくしてよい結果は出ないということ。", "kotae": "まかぬ種は生えぬ"},
{"quesion" : "争わず、あえて勝ちを譲ることで、一時的には負けていても、結果的に有利になり、勝ちにつながるということ。", "kotae": "負けるが勝ち"}
];
