...
const quiz = [
{"quesion" : "すでにしてしまった失敗を後で後悔しても取り返しのつかない。だから後悔しないように注意しなさい。", "kotae": "後悔先に立たず"},
{"quesion" : "親のありがたみが解る頃には、すでに亡くなっているものだ。だから、親が元気なうちに孝行したほうが良い。", "kotae": "孝行のしたい時分に親は無し"},
{"quesion" : "うまく世渡りするためには、その土地ごとの習慣に合わせて生活するのがよいということ。", "kotae": "郷に入っては郷に従え"},
{"quesion" : "どんなに優れた人物でも、失敗することはあるというたとえ。", "kotae": "弘法にも筆の誤り"},
{"quesion" : "優れた名人・達人は、道具のよしあしに関係なく立派な仕事をするものだということ。", "kotae": "弘法筆を選ばず"}
];
