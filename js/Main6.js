...
const quiz = [
{"quesion" : "家柄の良さなどよりも育った環境のほうが、その人の人間性に大きく影響し、大切だということ。", "kotae": "氏より育ち"},
{"quesion" : "噓で言ったはずのことが、たまたま実験してしまうこと。", "kotae": "噓から出た誠"},
{"quesion" : "平気でうそをつくようになると、やがては盗みも平気でするようになる。だから噓はついてはいけないということ。", "kotae": "噓つきは泥棒の始まり"},
{"quesion" : "物事を順調に進めるためには、時と場合によっては噓をつくことも必要だということ。", "kotae": "噓も方便"},
{"quesion" : "カラスが鵜を真似て魚を捕ろうとしても、うまくいかない。身の程をわきまえず、人の真似をして失敗すること。", "kotae": "鵜の真似をする烏"}
];
