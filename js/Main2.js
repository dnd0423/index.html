...
const quiz = [
{"quesion" : "夏の暑さや冬の寒さは彼岸の頃には和らいで、過ごしやすくなるということ。", "kotae": "暑さ寒さも彼岸まで"},
{"quesion" : "目先の問題さえ片付けば、あとはどうなってもかまわない。なるようになれ、という無責任な態度。", "kotae": "後は野となれ山となれ"},
{"quesion" : "好きになると、相手の欠点までもが長所に見えてしまうということ。", "kotae": "あばたもえくぼ"},
{"quesion" : "二つの物を両方手に入れようとして、どちらも取り逃すこと。欲張りすぎて失敗すること。", "kotae": "虻蜂取らず"},
{"quesion" : "ものごとを、二つの立場の両方を満足させられるようにするのは難しい、ということ。", "kotae": "あちら立てればこちらが立たぬ"}
];
