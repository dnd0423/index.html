...
const quiz = [
{"quesion" : "立派な人は、常に慎重に行動して、軽はずみなことはしないものなので、危険なことには初めから近寄らない。", "kotae": "君子危うきに近寄らず"},
{"quesion" : "身につけた技能はいざと言うときに役立つことがある。", "kotae": "芸は身を助ける"},
{"quesion" : "犬と猿のように、二者の仲がとても悪いことのたとえ。", "kotae": "犬猿の仲"},
{"quesion" : "喧嘩をしたものは、どちらが悪いかに関係なく、どちらも同じように罰を与えるべきだということ。", "kotae": "喧嘩両成敗"},
{"quesion" : "月日がたつのがとても速いことのたとえ。また、時間を無駄にしてはいけないという戒め。", "kotae": "光陰矢のごとし"}
];
