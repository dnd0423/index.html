...
const quiz = [
{"quesion" : "他人に害を与えようとすれば、やがて自分もその報いをうけるということ。", "kotae": "人を呪わば穴二つ"},
{"quesion" : "噂をされるからには、必ず何かの原因、事実があるだろうということ。", "kotae": "火のない所に煙は立たぬ"},
{"quesion" : "思いがけないところから意外なものが出る。冗談が現実となる。", "kotae": "ひょうたんから駒が出る"},
{"quesion" : "他人を簡単に信用してはいけない。まずは用心しろということ。", "kotae": "人を見たら泥棒と思え"},
{"quesion" : "害になることばかりあって、利益になるような良いことが何もないこと。。", "kotae": "百害あって一利なし"}
];
