...
const quiz = [
{"quesion" : "幼いころの性格は、一生変わらないということ。", "kotae": "三つ子の魂百まで"},
{"quesion" : "心の狭い人ほど偉そうにふるまい、優れた人物はむしろ控えめで、素直な態度でいること。", "kotae": "実るほど頭が下がる稲穂かな"},
{"quesion" : "捨て身の覚悟で物事にあたって、はじめて成し遂げることができるということ。", "kotae": "身を捨ててこそ浮かぶ瀬もあれ"},
{"quesion" : "昔身に付けた技量のこと。また、それが年を取ってからも衰えないこと。", "kotae": "昔取った杵柄"},
{"quesion" : "理屈に反したことが世の中で通用するようになれば、逆に理屈の通った正義は行われなくなるということ。", "kotae": "無理が通れば道理引っ込む"}
];
